# Setup Facture Mail (pro, sans PDF)
...
- `EMAILJS_RECEIPT_PRIVATE_KEY`

## 2) Template EmailJS dedie facture (uniquement si fallback EmailJS)
Dans EmailJS:
...
4. Envoi principal via Resend (gratuit), fallback EmailJS si configure.
